...
<div class="box box-danger">
    <div class="box-header">
        ...
        <div class="box-tools pull-right">
            ...
            {% button url="cockpit_cms_articles_edit_<?php echo $params['article']->id; ?>" type="info" size="sm" icon="pencil" %}
    		{% button url="cockpit_cms_articles_delete_<?php echo $params['article']->id; ?>" type="danger" size="sm" icon="trash-o" confirmation="Vous confirmer vouloir supprimer cet article?" %}
        </div>
    </div>
	<div class="box-body">
